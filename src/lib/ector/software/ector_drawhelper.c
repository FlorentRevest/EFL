...
static RGBA_Comp_Func_Solid func_for_mode_solid[ECTOR_ROP_LAST] = {
        comp_func_solid_source_over,
        comp_func_solid_source
};

static RGBA_Comp_Func func_for_mode[ECTOR_ROP_LAST] = {
...
RGBA_Comp_Func ector_comp_func_span_get(Ector_Rop op, uint color EINA_UNUSED)
{
